...
--New Shit
createTrainerConversationTemplate("trainer_dark_rank", "force_rank_dark_master", "trainer_dark_rank_convotemplate")
createTrainerConversationTemplate("trainer_light_rank", "force_rank_light_master", "trainer_light_rank_convotemplate")
