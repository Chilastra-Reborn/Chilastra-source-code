...
TOTALNUMBEROFBADGESREQUIRED = 53 --39
NUMBEROFJEDIBADGESREQUIRED = 30 --30
NUMBEROFDIFFICULTBADGESREQUIRED = 15 --7
NUMBEROFEASYBADGESREQUIRED = 8 --2
...
function Glowing:isGlowing(pCreatureObject)
	...
	if self:countBadges(pCreatureObject) >= TOTALNUMBEROFBADGESREQUIRED then
		...
		player:sendSystemMessage("The Force is strong with you.")
	end
end
